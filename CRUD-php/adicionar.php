...
<body>
    ...
    <form class="formulario" method="POST" action="adicionar_action.php">
        <h2>Adicionar Usuário</h2>

        <div class="form-group">
            <label for="exampleInputEmail1">Nome</label>
            <input type="name" name="nome" class="form-control" id="exampleInputName1" aria-describedby="emailHelp" placeholder="Escreva o nome">
